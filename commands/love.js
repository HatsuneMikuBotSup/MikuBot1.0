module.exports = {
    ...
    execute(message, args, client) {
        var imagesJpg = 9;
        var imagesGif = 1;
        var shoutouts = ["You're cute teehee:star_struck: ", "Heyy Darling ", "Darling :heart: ", "Do you think I am cute? >.< ", "You're online! :heart_eyes: ", "Iv been waiting for u :eyes: ", "Hayyy ^w^ "];
